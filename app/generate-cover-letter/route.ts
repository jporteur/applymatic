...
{
  "reasoning": "2-3 sentence paragraph explaining why this role is a strong match for John, referencing specific skills and experience that align with the role. Be specific and honest — if it's a strong match say so, if it's moderate explain why.",
  "coverLetter": "Full professional cover letter addressed to the hiring team. 3-4 paragraphs. Opening that hooks attention, middle paragraphs connecting John's specific experience to the role requirements, closing with enthusiasm and call to action. Sign off as John Utah. Do not use placeholder brackets — write it fully."
}`
